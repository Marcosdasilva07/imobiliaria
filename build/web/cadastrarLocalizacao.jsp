    ...
    <div id="topo">
       ...
       <%@include file="validarLogin.jsp" %>
        ...
        <div id="conteudoLogin">
            <fieldset>
                <legend>Cadastrar Localização do Imóvel</legend>
                <form  name="form_cadastro_localizacao" method="post" action="recebeLocalizacao.jsp?action=cadastrar" onsubmit="return validar(this)" >
