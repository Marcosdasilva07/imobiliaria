    ...
    <input   type="submit" class="button" value="Pesquisar" />
        ...
        <div id="conteudo">
            ...
            <fieldset>
                ...
                <h4 align="center">Solicite a avaliação do seu imóvel</h4>

                <p>Talvez a mais importante pergunta do proprietário seja: <b>"Qual o valor do meu imóvel?"</b></p>

                <p>Como você pode obter uma avaliação de seu imóvel sem compromisso?
                    <br> Basta entrar em contato e faremos <b>Grátis</b> a avaliação do seu imóvel.
                    Estamos à disposição para sanar dúvidas.
                </p>
                <div id="textocontato">
                <fieldset>
                    <legend> <span class="glyphicon glyphicon-user"></span> Corretor Davy Galvão &nbsp CRECI: 18.701</legend>
                ...
                <div id="textocontato">
                <fieldset>
                    <legend><span class="glyphicon glyphicon-user"></span> Corretor Luiz Carlos &nbsp CRECI: 10959/8ª REGIÃO</legend>
