...
%>
        ...
        <div id="conteudoLogin">
            <fieldset>
                <legend>Alterar Endereço do Funcionário</legend>
                <form  name="form_cadastro_endereco" method="post" action="recebeEnderecoFuncionario.jsp?action=editar&idFuncionario=<%=idFuncionario%>" onsubmit="return validar(this)" >
