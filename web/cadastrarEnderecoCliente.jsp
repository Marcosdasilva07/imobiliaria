...
<html>
    <head>
        ...
        <title>Cadastrar Endereço de Cliente</title>
    </head>
    <body>
<script src="javascript/jquery.js"></script>
       ...
       <%@include file="validarLogin.jsp" %>
        ...
        <div id="conteudoLogin">
            <fieldset>
                <legend>Cadastrar Endereço do Cliente</legend>
                <form  name="form_cadastro_endereco" method="post" action="recebeEndereco.jsp?action=cadastrar" onsubmit="return validar(this)" >
